 ...
 *
 */
@BusinessMapping(id="INSERT_DEPARTMENT_MEMBER_TAG")
public class InsertMemberTag extends AbstractModule{
	...
	public void run(JSONObject resultHeaderObject, JSONObject resultBodyObject) {
		...
		paramterMap.put("order", parameterObject.getInt("order"));

		sqlSession.update("kr.or.visitkorea.system.DepartmentMapper.insertMemberTag", paramterMap);
