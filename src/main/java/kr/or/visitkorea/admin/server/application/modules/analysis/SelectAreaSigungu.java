 ...
 *
 */ 
@BusinessMapping(id="SELECT_AREA_SIGUNGU")
public class SelectAreaSigungu extends AbstractModule{
	...
	public void run(JSONObject resultHeaderObject, JSONObject resultBodyObject) {
		...
		List<HashMap<String, Object>> returnMap = sqlSession.selectList( 
			"kr.or.visitkorea.system.AnalysisMapper.selectAreaSigungu",	paramterMap );
		JSONArray json = new JSONArray(returnMap);
		String convertJSONString = json.toString();

		System.out.println("selectAreaSigungu.result.JSONArray :: " + convertJSONString);
