 ...
 *
 */ 
@BusinessMapping(id="SELECT_REPAIR")
public class SelectRepair extends AbstractModule{

	@Override
	public void run(JSONObject resultHeaderObject, JSONObject resultBodyObject) {

		HashMap<String, Object> paramterMap = new HashMap<String, Object>();
		if(parameterObject.has("repid"))
			paramterMap.put("repid", parameterObject.getString("repid"));
		
			
		List<HashMap<String, Object>> returnMap = sqlSession.selectList( 
			"kr.or.visitkorea.system.RepairMapper.selectRepair" , 
			paramterMap );
