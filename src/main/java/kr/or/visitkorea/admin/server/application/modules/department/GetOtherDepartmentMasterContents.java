 ...
 *
 */
@BusinessMapping(id="GET_OTHER_DEPARTMENT_M_CONTENT")
public class GetOtherDepartmentMasterContents extends AbstractModule{
	...
	public void run(JSONObject resultHeaderObject, JSONObject resultBodyObject) {
		...
		List<HashMap<String, Object>> contentList = sqlSession.selectList( 
				"kr.or.visitkorea.system.DepartmentMapper.getMasterContents" , 
				paramterMap );
