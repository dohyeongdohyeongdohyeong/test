 ...
 *
 */
@BusinessMapping(id="UPDATE_CITYTOUR_SINGLE_ROW")
public class UpdateCitytourSingleRow extends AbstractModule{
	...
	public void run(JSONObject resultHeaderObject, JSONObject resultBodyObject) {
		...
		int updateResult = sqlSession.update( 
				"kr.or.visitkorea.system.DatabaseMapper.updateCitytourTableRow" , 
				paramterMap );
