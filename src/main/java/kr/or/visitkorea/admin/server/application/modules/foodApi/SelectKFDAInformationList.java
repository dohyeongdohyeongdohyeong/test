...
@BusinessMapping(id="GET_KFDA_DATA_LIST")
public class SelectKFDAInformationList extends AbstractModule {

	@Override
	public void run(JSONObject resultHeaderObject, JSONObject resultBodyObject) {
		String mapperLocation = "kr.or.visitkorea.system.FoodApiMapper";
		String dataListSql = "KFDAInformationList";
		String dataCountingSql = "KFDAInformationListAmount";
