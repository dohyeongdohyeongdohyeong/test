...
@BusinessMapping(id="UPDATE_OTHER_DEPARTMENT")
public class UpdateOtherDepartment extends AbstractModule {
	...
	public int updateOtd(JSONObject obj) {
		...
		return sqlSession.update("kr.or.visitkorea.system.DepartmentMapper.updateDeptService", params);
	}
