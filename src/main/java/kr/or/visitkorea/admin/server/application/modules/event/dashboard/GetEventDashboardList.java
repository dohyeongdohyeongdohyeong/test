...
@BusinessMapping(id="SELECT_EVENT_DASHBOARD_LIST")
public class GetEventDashboardList extends AbstractModule implements IEventConstant {
	...
	public void run(JSONObject resultHeaderObject, JSONObject resultBodyObject) {
		...
		List<HashMap<String, Object>> resultMap =
				sqlSession.selectList("kr.or.visitkorea.system.EventResultMapper.selectEventDashboardList", params);
		List<HashMap<String, Object>> resultCnt =
				sqlSession.selectList("kr.or.visitkorea.system.EventResultMapper.selectEventDashboardListCnt", params);
