 ...
 *
 */
@BusinessMapping(id="GET_ALL_LINK_INFORMATION")
public class GetAllLinkInformation extends AbstractModule{
	...
	public void run(JSONObject resultHeaderObject, JSONObject resultBodyObject) {
		...
		List<HashMap<String, Object>> returnMap = sqlSession.selectList( 
				"kr.or.visitkorea.system.DatabaseMapper.getAllLinks" , 
				paramterMap );
