...
@BusinessMapping(id="GET_EVENT_USER_ENTRY_LIST")
public class GetEventUserEntryList extends AbstractModule {
	...
	public void run(JSONObject resultHeaderObject, JSONObject resultBodyObject) {
		...
		resultList = sqlSession.selectList("kr.or.visitkorea.system.EventResultMapper.selectEventUserEntryList", params);
