 ...
 *
 */
@BusinessMapping(id="REMOVE_MEMBER_TAG")
public class RemoveMemberTag extends AbstractModule{
	...
	public void run(JSONObject resultHeaderObject, JSONObject resultBodyObject) {
		...
		sqlSession.update("kr.or.visitkorea.system.TagsMapper.removeMemberTag", paramterMap);
