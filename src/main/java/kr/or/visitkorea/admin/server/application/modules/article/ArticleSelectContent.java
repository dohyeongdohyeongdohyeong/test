 ...
 *
 */
@BusinessMapping(id="ARTICLE_SELET_CONTENT")
public class ArticleSelectContent extends AbstractModule{
	...
	public void run(JSONObject resultHeaderObject, JSONObject resultBodyObject) {
		...
		paramterMap.put("sMode", parameterObject.getInt("sMode"));
		paramterMap.put("condition", parameterObject.getString("condition"));
		paramterMap.put("keyword", parameterObject.getString("keyword"));

		List<HashMap<String, Object>> returnMap = sqlSession.selectList( 
				"kr.or.visitkorea.system.ArticleMapper.selectContent" , 
				paramterMap );
