 ...
 *
 */
@BusinessMapping(id="UPDATE_DEPT_ORDER")
public class UpdateDeptOrder extends AbstractModule{
	...
	public void run(JSONObject resultHeaderObject, JSONObject resultBodyObject) {
		...
		int UpdateResult = sqlSession.insert("kr.or.visitkorea.system.DepartmentMapper.updateDeptAllOrder", paramterMap);
