 ...
 *
 */
@BusinessMapping(id="GET_IMAGE_INFORMATION_WITH_ODMID")
public class GetImageInformationWithOdmId extends AbstractModule{
	...
	public void run(JSONObject resultHeaderObject, JSONObject resultBodyObject) {
		...
		HashMap<String, Object> returnMap = sqlSession.selectOne( 
				"kr.or.visitkorea.system.DepartmentMapper.getImageInformation" , 
				paramterMap );
