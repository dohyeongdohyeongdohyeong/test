 ...
 *
 */ 
@BusinessMapping(id="SELECT_BANNER_LIST")
public class SelectBannerList extends AbstractModule{
...
//		System.out.println("SparameterObject.getString(\"des\") :: " + parameterObject.get("des"));
		List<HashMap<String, Object>> returnMap = sqlSession.selectList( 
			"kr.or.visitkorea.system.BannerMapper.selectBannerList" , 
			paramterMap );
...
//				paramterMap );
		...
		System.out.println("SelectBannertList.result.JSONArray :: " + convertJSONString);
