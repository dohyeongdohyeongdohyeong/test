...
@BusinessMapping(id="MONITORING_USER_DELETE")
public class MonitoringUserDelete extends AbstractModule {
	...
	public void run(JSONObject resultHeaderObject, JSONObject resultBodyObject) {
		...
		String Url = Call.getProperty("monitor.server") + "/User/Delete";
		try {
