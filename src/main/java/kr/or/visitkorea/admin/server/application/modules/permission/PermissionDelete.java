 ...
 *
 */
@BusinessMapping(id="PERMISSION_DELETE")
public class PermissionDelete extends AbstractModule{
	...
	public void run(JSONObject resultHeaderObject, JSONObject resultBodyObject) {
		...
		int deleteResult = 
				sqlSession.update("kr.or.visitkorea.system.PermissionMapper.permissionDelete", parameterMap);
