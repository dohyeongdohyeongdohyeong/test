...
@BusinessMapping(id="GET_NEW_RESTAURANT_LIST")
public class SelectNewRestaurentList extends AbstractModule {

	@Override
	public void run(JSONObject resultHeaderObject, JSONObject resultBodyObject) {
		String mapperLocation = "kr.or.visitkorea.system.FoodApiMapper";
		String dataListSql = "NewRestaurantList";
		String dataCountingSql = "NewRestaurantListAmount";
