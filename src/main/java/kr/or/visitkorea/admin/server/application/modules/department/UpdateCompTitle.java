 ...
 *
 */
@BusinessMapping(id="UPDATE_COMP_TITLE")
public class UpdateCompTitle extends AbstractModule{
	...
	public void run(JSONObject resultHeaderObject, JSONObject resultBodyObject) {
		...
		int insertResult = sqlSession.insert("kr.or.visitkorea.system.DepartmentMapper.updateDeptSection", paramterMap);
