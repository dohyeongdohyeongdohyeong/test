 ...
 *
 */
@BusinessMapping(id="PERMISSION_DEL_ALL_ADMIN")
public class PermissionDeleteAllAdmin extends AbstractModule{
	...
	public void run(JSONObject resultHeaderObject, JSONObject resultBodyObject) {
		...
		int deleteResult = 
				sqlSession.update("kr.or.visitkorea.system.PermissionMapper.permissionDeleteForTgrUser", parameterMap);
