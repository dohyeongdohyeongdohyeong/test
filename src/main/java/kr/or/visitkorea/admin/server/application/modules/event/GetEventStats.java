...
@BusinessMapping(id="GET_EVENT_STATS")
public class GetEventStats extends AbstractModule {
	...
	public void run(JSONObject resultHeaderObject, JSONObject resultBodyObject) {
		...
		List<HashMap<String, Object>> resultMap =
				sqlSession.selectList("kr.or.visitkorea.system.EventMapper.getEventStats", params);
