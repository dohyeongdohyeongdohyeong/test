...
@BusinessMapping(id="MONITORING_GROUP_UPDATE")
public class MonitoringGroupUpdate extends AbstractModule {
	...
	public void run(JSONObject resultHeaderObject, JSONObject resultBodyObject) {
		...
		Group.put("beforetitle", parameterObject.getString("beforetitle"));
		...
		String Url = Call.getProperty("monitor.server") + "/Group/Update";
