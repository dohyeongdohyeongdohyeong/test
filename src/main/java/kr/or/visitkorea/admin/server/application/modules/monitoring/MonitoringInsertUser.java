...
@BusinessMapping(id="MONITORING_INSERT_USER")
public class MonitoringInsertUser extends AbstractModule {
	...
	public void run(JSONObject resultHeaderObject, JSONObject resultBodyObject) {
		...
		String Url = Call.getProperty("monitor.server") + "/User/Insert";
		try {
