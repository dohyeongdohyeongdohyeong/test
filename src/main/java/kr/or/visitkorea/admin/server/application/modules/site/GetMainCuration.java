 ...
 *
 */
@BusinessMapping(id="GET_MAIN_CURATION")
public class GetMainCuration extends AbstractModule{
	...
	public void run(JSONObject resultHeaderObject, JSONObject resultBodyObject) {
		...
		List<Map<String, Object>> allShowcaseMap = sqlSession.selectList("kr.or.visitkorea.system.SiteMainMapper.getMainCuration", paramterMap);
