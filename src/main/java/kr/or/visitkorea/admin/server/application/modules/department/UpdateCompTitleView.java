 ...
 *
 */
@BusinessMapping(id="UPDATE_COMP_TITLE_VIEW")
public class UpdateCompTitleView extends AbstractModule{
	...
	public void run(JSONObject resultHeaderObject, JSONObject resultBodyObject) {
		...
		int insertResult = sqlSession.insert("kr.or.visitkorea.system.DepartmentMapper.updateDeptSectionView", paramterMap);
