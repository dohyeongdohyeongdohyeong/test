...
@BusinessMapping(id="SELECT_ARTICLE_TRAVEL_INFO")
public class SelectArticleTravelInfo extends AbstractModule {
	...
	public void run(JSONObject resultHeaderObject, JSONObject resultBodyObject) {
		...
		List<HashMap<String, Object>> resultMap = 
				sqlSession.selectList("kr.or.visitkorea.system.ArticleMapper.selectArticleTravelInfo", params);
