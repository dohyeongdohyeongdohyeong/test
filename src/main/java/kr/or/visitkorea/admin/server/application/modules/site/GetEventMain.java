 ...
 *
 */
@BusinessMapping(id="GET_EVENT_MAIN")
public class GetEventMain extends AbstractModule{
	...
	public void run(JSONObject resultHeaderObject, JSONObject resultBodyObject) {
		...
		for (Map<String, Object> subMainItem : subMainList) {
			...
			List<Map<String, Object>> detailList = sqlSession.selectList("kr.or.visitkorea.system.SiteMainMapper.getAllEventMain", paramterMap);
