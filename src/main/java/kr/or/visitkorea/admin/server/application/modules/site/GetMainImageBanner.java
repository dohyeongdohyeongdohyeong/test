 ...
 *
 */
@BusinessMapping(id="GET_MAIN_IMAGE_BANNER")
public class GetMainImageBanner extends AbstractModule{
	...
	public void run(JSONObject resultHeaderObject, JSONObject resultBodyObject) {
		...
		Map<String, Object> allShowcaseMap = sqlSession.selectOne("kr.or.visitkorea.system.SiteMainMapper.GetImageBanner", paramterMap);
