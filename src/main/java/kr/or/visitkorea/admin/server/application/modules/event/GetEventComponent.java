...
@BusinessMapping(id="GET_EVENT_COMPONENT")
public class GetEventComponent extends AbstractModule {
	...
	public void run(JSONObject resultHeaderObject, JSONObject resultBodyObject) {
		...
		List<HashMap<String, Object>> resultMap =
				sqlSession.selectList("kr.or.visitkorea.system.EventMapper.getEventComponent", params);
