 ...
 *
 */
@BusinessMapping(id="ARTICLE_RELATED_CONTENT_LIST")
public class ArticleRelatedContentList extends AbstractModule{
	...
	public void run(JSONObject resultHeaderObject, JSONObject resultBodyObject) {
		...
		List<HashMap<String, Object>> returnMap = sqlSession.selectList( 
				"kr.or.visitkorea.system.ArticleMapper.articleRelatedContentList" , 
				paramterMap );
