...
@BusinessMapping(id="MONITORING_GROUP_INDEX_DOWN")
public class MonitoringGroupIndexdown extends AbstractModule {
	...
	public void run(JSONObject resultHeaderObject, JSONObject resultBodyObject) {
		...
		Group.put("GroupName", parameterObject.getString("GroupName"));
		String sendgroup = Group.toString();
		
		String Url = Call.getProperty("monitor.server") + "/Group/IndexDown";
