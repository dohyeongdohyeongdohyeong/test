...
@BusinessMapping(id="SELECT_STAFF_MODIFY_HISTORY")
public class SelectStaffModifyHistory extends AbstractModule {
	...
	public void run(JSONObject resultHeaderObject, JSONObject resultBodyObject) {
		...
		List<HashMap<String, Object>> returnMap =
				sqlSession.selectList("kr.or.visitkorea.system.StaffMapper.selectStaffModifyHistory", params);
		
		int totalCnt = sqlSession.selectOne("kr.or.visitkorea.system.StaffMapper.selectStaffModifyHistoryCnt", params);
