 ...
 *
 */ 
@BusinessMapping(id="SELECT_PARTNERS_CHANNEL_LIST")
public class SelectChannelList extends AbstractModule{
	...
	public void run(JSONObject resultHeaderObject, JSONObject resultBodyObject) {
		...
		List<HashMap<String, Object>> returnMap = sqlSession.selectList( 
			"kr.or.visitkorea.system.PartnersMapper.selectChannelList" , 
			paramterMap );
		List<HashMap<String, Object>> returnCnt = sqlSession.selectList( 
				"kr.or.visitkorea.system.PartnersMapper.selectChannelListCnt" , 
				paramterMap );
		
		JSONArray json = new JSONArray(returnMap);
		String convertJSONString = json.toString();

		System.out.println("selectChannelList.result.JSONArray :: " + convertJSONString);
