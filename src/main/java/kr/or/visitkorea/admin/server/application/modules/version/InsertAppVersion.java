...
@BusinessMapping(id="INSERT_APP_VERSION")
public class InsertAppVersion extends AbstractModule {
    ...
    public void run(JSONObject resultHeaderObject, JSONObject resultBodyObject) {
        ...
        int insert = sqlSession.insert("kr.or.visitkorea.system.AppVersionMapper.insert", version);
        if (insert == 1) {
