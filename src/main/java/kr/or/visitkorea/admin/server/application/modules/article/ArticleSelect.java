 ...
 *
 */
@BusinessMapping(id="ARTICLE_SELECT_WITH_COTID")
public class ArticleSelect extends AbstractModule{
	...
	public void run(JSONObject resultHeaderObject, JSONObject resultBodyObject) {
		...
		resultObj.put("result", new JSONObject(returnSelectCotIdMap));
