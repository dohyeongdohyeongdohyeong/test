...
@BusinessMapping(id="GET_EVENT_RESULT_COMPONENT")
public class GetEventResultComponent extends AbstractModule {
	...
	public void run(JSONObject resultHeaderObject, JSONObject resultBodyObject) {
		...
		List<HashMap<String, Object>> resultMap =
				sqlSession.selectList("kr.or.visitkorea.system.EventMapper.getEventResultComponent", params);
