 ...
 *
 */
@BusinessMapping(id="SETUP_MASTER_TAG")
public class SetupMasterTag extends AbstractModule{
	...
	public void run(JSONObject resultHeaderObject, JSONObject resultBodyObject) {
		...
		sqlSession.update("kr.or.visitkorea.system.TagsMapper.updateContentTagAllCancel", paramterMap);
		sqlSession.update("kr.or.visitkorea.system.TagsMapper.updateContentTag", paramterMap);
		
		List<HashMap<String, Object>> returnMap = sqlSession.selectList( 
				"kr.or.visitkorea.system.TagsMapper.getContentMasterTag" , 
				paramterMap );
