 ...
 *
 */
@BusinessMapping(id="GET_CULTURAL_FACILITIES")
public class GetCultualFacilities extends AbstractModule{
	...
	public void run(JSONObject resultHeaderObject, JSONObject resultBodyObject) {
		...
		HashMap<String, Object> introMap = sqlSession.selectOne( 
				"kr.or.visitkorea.system.DatabaseMapper.getCulturlaFacilitiesIntro" , 
				paramterMap );
