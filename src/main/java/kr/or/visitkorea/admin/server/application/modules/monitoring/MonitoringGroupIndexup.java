...
@BusinessMapping(id="MONITORING_GROUP_INDEX_UP")
public class MonitoringGroupIndexup extends AbstractModule {
	...
	public void run(JSONObject resultHeaderObject, JSONObject resultBodyObject) {
		...
		String Url = Call.getProperty("monitor.server") + "/Group/IndexUp";
