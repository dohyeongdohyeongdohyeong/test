 ...
 *
 */ 
@BusinessMapping(id="SELECT_REPAIRMAN_LIST")
public class SelectRepairManList extends AbstractModule{
	...
	public void run(JSONObject resultHeaderObject, JSONObject resultBodyObject) {
		...
		List<HashMap<String, Object>> returnMap = sqlSession.selectList( 
			"kr.or.visitkorea.system.RepairMapper.selectRepairManList" , 
			paramterMap );
		List<HashMap<String, Object>> returnCnt = sqlSession.selectList( 
			"kr.or.visitkorea.system.RepairMapper.selectRepairManListCnt" , 
			paramterMap );
		
		JSONArray json = new JSONArray(returnMap);
		String convertJSONString = json.toString();

		System.out.println("selectRepairManList.result.JSONArray :: " + convertJSONString);
