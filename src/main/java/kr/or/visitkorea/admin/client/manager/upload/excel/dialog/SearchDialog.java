...
public class SearchDialog extends DialogContent {
    ...
    private final ExcelImageUploadApplication.OnSearchListener onSearchListener;

    private MaterialInput startInput;
    private MaterialInput endInput;

    public SearchDialog(MaterialExtentsWindow window, ExcelImageUploadApplication.OnSearchListener listener) {
        super(window);
    ...
    public void init() {
        ...
        button.addClickHandler(event -> {
            if (onSearchListener != null) {
                onSearchListener.onSearch(startInput.getText(), endInput.getText());
            }
