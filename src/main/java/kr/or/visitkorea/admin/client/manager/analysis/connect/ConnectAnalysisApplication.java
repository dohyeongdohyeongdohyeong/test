...
public class ConnectAnalysisApplication extends ApplicationBase{
	
	public ConnectAnalysisApplication(ApplicationView applicationView) {
	...
	public void start(Map<String, Object> params) {
		this.params = params;
		this.window.add(new ConnectAnalysisMain(this.window, this));
