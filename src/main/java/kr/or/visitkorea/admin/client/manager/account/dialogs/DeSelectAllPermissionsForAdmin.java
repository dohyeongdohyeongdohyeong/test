...
public class DeSelectAllPermissionsForAdmin extends DialogContent {

	private MaterialLabel label1;
	private MaterialLabel label2;
	private MaterialButton selectButton;
			
	public DeSelectAllPermissionsForAdmin(MaterialExtentsWindow window) {
		super(window); 
	}
	...
	public void init() {
		...
		selectButton.addClickHandler(event->{
			...
			parameterJSON.put("cmd", new JSONString("PERMISSION_DEL_ALL_ADMIN"));
			...
			VisitKoreaBusiness.post("call", parameterJSON.toString(), new Func3<Object, String, Object>() {
				...
				public void call(Object param1, String param2, Object param3) {
					...
					label1.setText("권한 해제를 완료했습니다. ");
					label2.setText("모든 권한이 해제 되었습니다. ");
	...
	protected void onLoad() {
       super.onLoad();
		label1.setText("시스템관리 속성을 포함하여 모든 권한을 해제 합니다.");
		label2.setText("권한을 해제 하시겠습니까?");
