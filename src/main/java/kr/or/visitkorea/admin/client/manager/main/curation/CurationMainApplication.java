package kr.or.visitkorea.admin.client.manager.main.curation;
...
public class CurationMainApplication extends ApplicationBase{
	
	public CurationMainApplication(ApplicationView applicationView) {
