...
package kr.or.visitkorea.admin.client.manager.main.recommand.dialogs;
...
public class SelectYearMonthDialog extends DialogContent {
	...
	public void init() {
		...
		selectButton.addClickHandler(event->{
			...
			ContentOrderedPanel cop = (ContentOrderedPanel)this.getParameters().get("CONTENT_ORDERED_PANEL");
			cop.reset(new DefaultConntentComposite());
			cop.load(selectedLabel.getText());
