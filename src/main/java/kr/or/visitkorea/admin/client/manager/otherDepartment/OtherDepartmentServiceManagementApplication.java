...
import kr.or.visitkorea.admin.client.manager.otherDepartment.composite.service.OtherDepartmentServiceManagement;
import kr.or.visitkorea.admin.client.widgets.window.MaterialExtentsWindow;

public class OtherDepartmentServiceManagementApplication extends ApplicationBase{
	
	public OtherDepartmentServiceManagementApplication(ApplicationView applicationView) {
	...
	public void start(Map<String, Object> params) {
		this.params = params;
		this.window.add(new OtherDepartmentServiceManagement(this.window));
