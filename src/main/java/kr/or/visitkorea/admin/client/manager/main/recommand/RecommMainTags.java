...
public class RecommMainTags extends AbstractContentPanel {
	...
	public RecommMainTags(MaterialExtentsWindow meWindow) {
		super(meWindow);
	}
	...
	private void buildTitle() {
		MaterialLabel titleLabel = new MaterialLabel("- 추천 메인 :: 태그");
