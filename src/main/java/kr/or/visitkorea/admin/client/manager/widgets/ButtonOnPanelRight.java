...
public class ButtonOnPanelRight extends Span {
     ...
     */
    public ButtonOnPanelRight() {
        super(Document.get().createSpanElement(), "buttonOnPanelLeft");
    }

    /**
     * @param text text of the badge
     */
    public ButtonOnPanelRight(String text) {
        this();
        setText(text);
    }
     ...
     */
    public ButtonOnPanelRight(String text, boolean isCircle) {
        this();
        setText(text);
        setCircle(isCircle);
    }
     ...
     */
    public ButtonOnPanelRight(String text, Color textColor, Color bgColor) {
        this();
        setText(text);
