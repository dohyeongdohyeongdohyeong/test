...
import kr.or.visitkorea.admin.client.manager.widgets.dnd.client.util.impl.DOMUtilImpl;
import kr.or.visitkorea.admin.client.manager.widgets.dnd.client.util.impl.DOMUtilImplMozilla;
import kr.or.visitkorea.admin.client.manager.widgets.dnd.client.util.impl.DOMUtilImplStandard;
...
public class DOMUtil {
  ...
  static {
    impl = (DOMUtilImpl) GWT.create(DOMUtilImplMozilla.class);
  }
