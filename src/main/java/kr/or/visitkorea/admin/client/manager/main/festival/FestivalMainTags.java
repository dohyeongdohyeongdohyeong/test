...
public class FestivalMainTags extends AbstractContentPanel {
	...
	public FestivalMainTags(MaterialExtentsWindow meWindow) {
		super(meWindow);
	}
	...
	private void buildTitle() {
		MaterialLabel titleLabel = new MaterialLabel("- 축제 메인 :: 태그");
