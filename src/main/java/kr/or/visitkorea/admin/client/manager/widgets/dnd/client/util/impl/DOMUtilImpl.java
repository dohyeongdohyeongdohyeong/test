 ...
 * the License.
 */
package kr.or.visitkorea.admin.client.manager.widgets.dnd.client.util.impl;

import com.google.gwt.dom.client.Element;
import com.google.gwt.user.client.ui.Widget;

/*
 * {@link kr.or.visitkorea.admin.client.manager.widgets.dnd.client.util.DOMUtil} default cross-browser implementation.
 */
public abstract class DOMUtilImpl {
  ...
  public native String getEffectiveStyle(Element elem, String style) /*-{
    return this.@kr.or.visitkorea.admin.client.manager.widgets.dnd.client.util.impl.DOMUtilImpl::getComputedStyle(Lcom/google/gwt/dom/client/Element;Ljava/lang/String;)(elem,style)
