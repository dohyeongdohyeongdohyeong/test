package kr.or.visitkorea.admin.client.manager.main.department;
...
public class DepartmentMainApplication extends ApplicationBase{
	
	public DepartmentMainApplication(ApplicationView applicationView) {
