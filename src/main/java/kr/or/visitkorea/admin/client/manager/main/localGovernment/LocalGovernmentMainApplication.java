package kr.or.visitkorea.admin.client.manager.main.localGovernment;
...
public class LocalGovernmentMainApplication extends ApplicationBase{
	
	public LocalGovernmentMainApplication(ApplicationView applicationView) {
