...
public class EventContentLayoutB extends ContentLayoutPanel {

	private CategoryMainContentPanel leftPanel;
	private CategoryMainContentPanel rightPanel;
	...
	protected void init() {
		...
		leftPanel = this.addCategoryMainContentPanel(this, 227, 175, 70, 0);
		rightPanel =  this.addCategoryMainContentPanel(this, 227, 175, 70, 235);
	}
	...
	public void setWindow(MaterialExtentsWindow materialExtentsWindow) {
		...
		leftPanel.setWindow(materialExtentsWindow);
		rightPanel.setWindow(materialExtentsWindow);
	}
	...
	public JSONObject getJSONObject() {
		...
		if (retJSONObject == null) {
			...
			retJSONObject.put("COMP_TYPE", new JSONString("2"));
		} else {
			retJSONObject.put("SUB_TITLE", new JSONString(this.subTitle.getValue()));
			retJSONObject.put("TITLE", new JSONString(this.mainTitle.getValue()));
			retJSONObject.put("COMP_TYPE", new JSONString("2"));
		...
		contentArray.set(0, leftPanel.getJSONObject());
		contentArray.set(1, rightPanel.getJSONObject());
