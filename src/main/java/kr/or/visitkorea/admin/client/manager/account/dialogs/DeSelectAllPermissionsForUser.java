...
public class DeSelectAllPermissionsForUser extends DialogContent {
	...
	public DeSelectAllPermissionsForUser(MaterialExtentsWindow window) {
		super(window); 
	}
	...
	public void init() {
		...
		label1 = new MaterialLabel("시스템관리 속성을 제외하는 모든 권한을 해제 합니다.");
	...
	protected void onLoad() {
       super.onLoad();
		label1.setText("시스템관리 속성을 제외하는 모든 권한을 해제 합니다.");
