...
public class ButtonOnPanel extends Span {
     ...
     */
    public ButtonOnPanel() {
        super(Document.get().createSpanElement(), "buttonOnPanel", "text_border");
    }

    /**
     * @param text text of the badge
     */
    public ButtonOnPanel(String text) {
        this();
        setText(text);
    }
     ...
     */
    public ButtonOnPanel(String text, boolean isCircle) {
        this();
        setText(text);
        setCircle(isCircle);
    }
     ...
     */
    public ButtonOnPanel(String text, Color textColor, Color bgColor) {
        this();
        setText(text);
