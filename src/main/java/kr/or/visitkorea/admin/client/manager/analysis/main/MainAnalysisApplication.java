...
public class MainAnalysisApplication extends ApplicationBase{
	
	public MainAnalysisApplication(ApplicationView applicationView) {
	...
	public void start(Map<String, Object> params) {
		this.params = params;
		this.window.add(new MainAnalysisMain(this.window, this));
