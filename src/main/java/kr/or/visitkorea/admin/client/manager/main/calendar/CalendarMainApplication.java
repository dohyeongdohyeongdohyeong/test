package kr.or.visitkorea.admin.client.manager.main.calendar;
...
public class CalendarMainApplication extends ApplicationBase{
	
	public CalendarMainApplication(ApplicationView applicationView) {
