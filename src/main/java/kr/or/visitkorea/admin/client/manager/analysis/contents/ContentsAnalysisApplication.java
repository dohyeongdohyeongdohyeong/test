...
public class ContentsAnalysisApplication extends ApplicationBase{
	
	public ContentsAnalysisApplication(ApplicationView applicationView) {
	...
	public void start(Map<String, Object> params) {
		this.params = params;
		this.window.add(new ContentsAnalysisMain(this.window, this));
