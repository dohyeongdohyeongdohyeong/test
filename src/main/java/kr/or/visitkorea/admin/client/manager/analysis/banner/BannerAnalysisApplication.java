...
public class BannerAnalysisApplication extends ApplicationBase{
	
	public BannerAnalysisApplication(ApplicationView applicationView) {
	...
	public void start(Map<String, Object> params) {
		this.params = params;
		this.window.add(new BannerAnalysisMain(this.window, this));
