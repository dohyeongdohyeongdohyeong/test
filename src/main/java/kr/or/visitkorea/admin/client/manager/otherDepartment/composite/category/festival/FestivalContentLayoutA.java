...
public class FestivalContentLayoutA extends ContentLayoutPanel {
	...
	public FestivalContentLayoutA(ContentSection contentSection) {
	...
	protected void layoutInit() {
		...
		if (this.contentSection != null) {
			leftTopPannel = new CategoryMainContentPanel(this.contentSection);
		} else {
		...
		if (this.contentSection != null) {
			leftBottomPannel = new CategoryMainContentPanel(this.contentSection);
		} else {
