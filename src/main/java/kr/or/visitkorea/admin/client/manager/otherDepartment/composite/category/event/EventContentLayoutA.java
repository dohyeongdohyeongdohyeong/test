...
public class EventContentLayoutA extends ContentLayoutPanel {
	...
	protected void init() {
		...
		mainPannel = this.addCategoryMainContentPanel(this, 461, 175, 70, 0);
	}
	...
	public JSONObject getJSONObject() {
		...
		if (retJSONObject == null) {
			...
			retJSONObject.put("COMP_TYPE", new JSONString("1"));
		} else {
			retJSONObject.put("SUB_TITLE", new JSONString(this.subTitle.getValue()));
			retJSONObject.put("TITLE", new JSONString(this.mainTitle.getValue()));
			retJSONObject.put("COMP_TYPE", new JSONString("1"));
