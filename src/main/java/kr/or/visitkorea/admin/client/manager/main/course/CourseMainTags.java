...
public class CourseMainTags extends AbstractContentPanel {
	...
	public CourseMainTags(MaterialExtentsWindow meWindow) {
		super(meWindow);
	}
	...
	private void buildTitle() {
		MaterialLabel titleLabel = new MaterialLabel("- 코스 메인 :: 태그");
