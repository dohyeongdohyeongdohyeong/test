...
public class SelectAllPermissionsForUser extends DialogContent {
	...
	public SelectAllPermissionsForUser(MaterialExtentsWindow window) {
		super(window); 
	}
	...
	public void init() {
		...
		label1 = new MaterialLabel("시스템관리 속성을 제외하는 모든 권한을 부여합니다.");
		...
		selectButton.addClickHandler(event->{
			...
			parameterJSON.put("cmd", new JSONString("PERMISSION_INS_ALL_USER"));
...
*/
	...
	protected void onLoad() {
       super.onLoad();
		label1.setText("시스템관리 속성을 제외하는 모든 권한을 부여합니다.");
