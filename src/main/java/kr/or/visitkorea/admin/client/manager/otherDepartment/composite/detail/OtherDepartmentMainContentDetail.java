...
public class OtherDepartmentMainContentDetail extends AbtractOtherDepartmentMainContents {
	...
	public OtherDepartmentMainContentDetail(MaterialExtentsWindow materialExtentsWindow, OtherDepartmentMainEditor otherDepartmentMainEditor) {
		super(materialExtentsWindow);
		this.otherDepartmentMainEditor = otherDepartmentMainEditor;
		Registry.put("OtherDepartmentMainContentDetail", this);
	}
	...
	private void buildContent() {
		...
		addLabel(row1, "더보기 연결 정보", TextAlign.CENTER, Color.GREY_LIGHTEN_3,"s3");
	...
	public void setAreaComponent(AreaComponent aac) {
		...
		for (int idx=1; idx<infoList.size(); idx++) {
			...
			if (COT_ID.equals("")) {
				...
				if (jObj.get("LINK_FILE_URL") != null) {
					DISP_STR = "파일 링크";
				} else if (jObj.get("LINK_URL") != null) {
					DISP_STR = "URL 링크";
				}
