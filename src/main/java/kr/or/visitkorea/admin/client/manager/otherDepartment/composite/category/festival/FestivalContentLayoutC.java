...
public class FestivalContentLayoutC extends ContentLayoutPanel {
	...
	public FestivalContentLayoutC(ContentSection contentSection) {
	...
	protected void layoutInit() {
		...
		mainPannel = new CategoryMainContentPanel(ContentSection.FESTIVAL);
		...
		bottomPannel01 = new CategoryMainContentPanel(ContentSection.FESTIVAL);
		...
		bottomPannel02 = new CategoryMainContentPanel(ContentSection.FESTIVAL);
		...
		bottomPannel03 = new CategoryMainContentPanel(ContentSection.FESTIVAL);
		...
		bottomPannel04 = new CategoryMainContentPanel(ContentSection.FESTIVAL);
