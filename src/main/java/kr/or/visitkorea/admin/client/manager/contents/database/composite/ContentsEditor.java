...
public class ContentsEditor extends AbtractContents {

	private MaterialRichEditor editor;
	private ContentTreeItem treeItem;
	private String title = "정보 편집기";

	public ContentsEditor(MaterialExtentsWindow materialExtentsWindow) {
...
//		Console.log(treeItem.getText());
		editor.setHTML(this.treeItem.getEditorSafeValue().asString());
	}
